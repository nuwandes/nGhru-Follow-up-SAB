...
class MeasurementListActivity : AppCompatActivity(), HasSupportFragmentInjector {
    @Inject
    lateinit var dispatchingAndroidInjector: DispatchingAndroidInjector<Fragment>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.measurement_list_activity)
    ...
    private fun setupNavigationByCountry() {
        ...
        val navNewSg = inflater.inflate(R.navigation.measurement_list)
