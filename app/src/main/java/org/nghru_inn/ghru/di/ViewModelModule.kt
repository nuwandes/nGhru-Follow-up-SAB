...
import org.nghru_inn.ghru.ui.activitytracker.activitytracker.ActivityTackeViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.bodycomposition.BodyCompositionViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.bp.BPViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.bp.info.InfoViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.bp.main.BPMainViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.bp.manual.one.BPManualOneViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.bp.manual.three.BPManualThreeViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.bp.manual.two.BPManualTwoViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.bp.skip.SkipDialogViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.height.HeightViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.hipwaist.HipWaistViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.home.BodyMeasurementHomeViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.measurements.MeasurementsViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.measurements.second.MeasurementsSecondViewModel
import org.nghru_inn.ghru.ui.bodymeasurements.verifyid.VerifyIDViewModel
import org.nghru_inn.ghru.ui.codeheck.CodeCheckDialogViewModel
import org.nghru_inn.ghru.ui.datamanagement.DataManagmentViewModel
import org.nghru_inn.ghru.ui.devices.DevicesViewModel
import org.nghru_inn.ghru.ui.ecg.main.InputViewModel
import org.nghru_inn.ghru.ui.ecg.trace.TraceViewModel
import org.nghru_inn.ghru.ui.ecg.trace.complete.CompleteDialogViewModel
import org.nghru_inn.ghru.ui.ecg.verifyid.ECGVerifyIDViewModel
import org.nghru_inn.ghru.ui.enumeration.EnumerationViewModel
import org.nghru_inn.ghru.ui.enumeration.concent.ConcentViewModel
import org.nghru_inn.ghru.ui.enumeration.concent.reasondialog.ReasonDialogViewModel
import org.nghru_inn.ghru.ui.enumeration.createhousehold.CreateHouseholdViewModel
import org.nghru_inn.ghru.ui.enumeration.householdmembers.HouseholdMembersViewModel
import org.nghru_inn.ghru.ui.enumeration.householdmembers.asigndialog.AsignDialogViewModel
import org.nghru_inn.ghru.ui.enumeration.member.AddHouseHoldMemberViewModel
import org.nghru_inn.ghru.ui.enumeration.registergeolocation.RegisterGeolocationViewModel
import org.nghru_inn.ghru.ui.fundoscopy.guide.GuideViewModel
import org.nghru_inn.ghru.ui.fundoscopy.guide.main.GuideMainViewModel
import org.nghru_inn.ghru.ui.fundoscopy.reading.FundoscopyReadingViewModel
import org.nghru_inn.ghru.ui.fundoscopy.verifyid.FundoscopyVerifyIDViewModel
import org.nghru_inn.ghru.ui.home.HomeViewModel
import org.nghru_inn.ghru.ui.homeenumeration.HomeEnumerationViewModel
import org.nghru_inn.ghru.ui.homeenumerationlist.HomeEmumerationListViewModel
import org.nghru_inn.ghru.ui.login.LoginViewModel
import org.nghru_inn.ghru.ui.registerpatient.basicdetails.BasicDetailsViewModel
import org.nghru_inn.ghru.ui.registerpatient.checklist.CheckListViewModel
import org.nghru_inn.ghru.ui.registerpatient.confirmation.ConfirmationViewModel
import org.nghru_inn.ghru.ui.registerpatient.confirmation.completed.CompletedDialogViewModel
import org.nghru_inn.ghru.ui.registerpatient.explanation.ExplanationViewModel
import org.nghru_inn.ghru.ui.registerpatient.explanation.reasondialog.ExplanationDialogViewModel
import org.nghru_inn.ghru.ui.registerpatient.identification.IdentificationViewModel
import org.nghru_inn.ghru.ui.registerpatient.scanbarcode.ScanBarcodeViewModel
import org.nghru_inn.ghru.ui.registerpatient.scanqrcode.ScanQRCodeViewModel
import org.nghru_inn.ghru.ui.registerpatient.scanqrcode.errordialog.ErrorDialogViewModel
import org.nghru_inn.ghru.ui.registerpatient.scanqrcode.membersdialog.MembersDialogViewModel
import org.nghru_inn.ghru.ui.registerpatient_new.basicdetails.BasicDetailsViewModelNew
import org.nghru_inn.ghru.ui.registerpatient_new.confirmation.ConfirmationViewModelNew
import org.nghru_inn.ghru.ui.registerpatient_new.confirmation.completed.CompletedDialogViewModelNew
import org.nghru_inn.ghru.ui.registerpatient_new.scanbarcode.ScanBarcodeViewModelNew
import org.nghru_inn.ghru.ui.registerpatient_new.scanbarcode.manualentry.ManualEntryScanBarcodeViewModelNew
import org.nghru_inn.ghru.ui.registerpatient_sg.basicdetails.BasicDetailsViewModelSG
import org.nghru_inn.ghru.ui.registerpatient_sg.checklist.CheckListViewModelSG
import org.nghru_inn.ghru.ui.registerpatient_sg.confirmation.ConfirmationViewModelSG
import org.nghru_inn.ghru.ui.registerpatient_sg.explanation.ExplanationViewModelSG
import org.nghru_inn.ghru.ui.registerpatient_sg.scanbarcode.ScanBarcodeViewModelSG
import org.nghru_inn.ghru.ui.registerpatient_sg.scanbarcode.manualentry.ManualEntryScanBarcodeViewModelSG
import org.nghru_inn.ghru.ui.samplecollection.bagscanbarcode.BagScanBarcodeViewModel
import org.nghru_inn.ghru.ui.samplecollection.bagscanned.BagScannedViewModel
import org.nghru_inn.ghru.ui.samplecollection.fast.FastViewModel
import org.nghru_inn.ghru.ui.samplecollection.fast.reshedule.ResheduleDialogViewModel
import org.nghru_inn.ghru.ui.samplecollection.fasted.FastedViewModel
import org.nghru_inn.ghru.ui.samplemanagement.fastingbloodglucose.FastingBloodGlucoseViewModel
import org.nghru_inn.ghru.ui.samplemanagement.hb1ac.Hb1AcViewModel
import org.nghru_inn.ghru.ui.samplemanagement.hogtt.HOGTTViewModel
import org.nghru_inn.ghru.ui.samplemanagement.home.SampleMangementHomeViewModel
import org.nghru_inn.ghru.ui.samplemanagement.lipidprofile.LipidProfileViewModel
import org.nghru_inn.ghru.ui.samplemanagement.pendingsamplelist.PendingSampleListViewModel
import org.nghru_inn.ghru.ui.samplemanagement.storage.transfer.TransferViewModel
import org.nghru_inn.ghru.ui.samplemanagement.tubescanbarcode.TubeScanBarcodeViewModel
import org.nghru_inn.ghru.ui.setting.SettingViewModel
import org.nghru_inn.ghru.ui.station.StationViewModel
import org.nghru_inn.ghru.ui.visitedhouseholds.VisitedHouseholdViewModel
import org.nghru_inn.ghru.viewmodel.GithubViewModelFactory
...
abstract class ViewModelModule {
    ...
    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.registerpatient.review.ReviewViewModel::class)
    abstract fun bindReviewViewModelX(reviewViewModel: org.nghru_inn.ghru.ui.registerpatient.review.ReviewViewModel): ViewModel

    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.registerpatient_sg.review.ReviewViewModelSG::class)
    abstract fun bindReviewViewModelXSg(reviewViewModelSg: org.nghru_inn.ghru.ui.registerpatient_sg.review.ReviewViewModelSG): ViewModel

    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.registerpatient_new.review.ReviewViewModelNew::class)
    abstract fun bindReviewViewModelXNew(reviewViewModelSg: org.nghru_inn.ghru.ui.registerpatient_new.review.ReviewViewModelNew): ViewModel
...
//    abstract fun bindStatusCompletedDialogViewModel(statusCompletedDialogViewModel: StatusCompletedDialogViewModel): ViewModel
    ...
    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.bodymeasurements.scanbarcode.ScanBarcodeViewModel::class)
    abstract fun bindScanBarcodeViewModelX(scanBarcodeViewModelX: org.nghru_inn.ghru.ui.bodymeasurements.scanbarcode.ScanBarcodeViewModel): ViewModel
    ...
    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.bodymeasurements.review.completed.CompletedDialogViewModel::class)
    abstract fun bindCompletedDialogViewModelX(completedDialogViewModel: org.nghru_inn.ghru.ui.bodymeasurements.review.completed.CompletedDialogViewModel): ViewModel
    ...
    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.ecg.scanbarcode.ScanBarcodeViewModel::class)
    abstract fun bindScanBarcodeViewModelXY(ScanBarcodeViewModel: org.nghru_inn.ghru.ui.ecg.scanbarcode.ScanBarcodeViewModel): ViewModel
    ...
    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.fundoscopy.scanbarcode.ScanBarcodeViewModel::class)
    abstract fun bindScanBarcodeFragment(ScanBarcodeViewModel: org.nghru_inn.ghru.ui.fundoscopy.scanbarcode.ScanBarcodeViewModel): ViewModel

    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.fundoscopy.displaybarcode.DisplayBarcodeViewModel::class)
    abstract fun bindDisplayBarcodeViewModel(DisplayBarcodeViewModel: org.nghru_inn.ghru.ui.fundoscopy.displaybarcode.DisplayBarcodeViewModel): ViewModel


    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.samplecollection.scanbarcode.ScanBarcodeViewModel::class)
    abstract fun bindScanBarcodeViewModelXYZ(guideMainViewModel: org.nghru_inn.ghru.ui.samplecollection.scanbarcode.ScanBarcodeViewModel): ViewModel

    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.samplecollection.verifyid.VerifyIDViewModel::class)
    abstract fun bindVerifyIDViewModelXY(VerifyIDViewModel: org.nghru_inn.ghru.ui.samplecollection.verifyid.VerifyIDViewModel): ViewModel
    ...
    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.samplecollection.bagscanned.reason.ReasonDialogViewModel::class)
    abstract fun bindReasonDialogViewModelxxx(reasonDialogViewModel: org.nghru_inn.ghru.ui.samplecollection.bagscanned.reason.ReasonDialogViewModel): ViewModel
    ...
    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.ecg.trace.reason.ReasonDialogViewModel::class)
    abstract fun bindReasonDialogViewModelsdewd(completeDialogViewModel: org.nghru_inn.ghru.ui.ecg.trace.reason.ReasonDialogViewModel): ViewModel

    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.fundoscopy.reading.reason.ReasonDialogViewModel::class)
    abstract fun bindFReasonDialogViewModelsdewd(reasonDialogViewModel: org.nghru_inn.ghru.ui.fundoscopy.reading.reason.ReasonDialogViewModel): ViewModel
    ...
    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.questionnaire.scanbarcode.ScanBarcodeViewModel::class)
    abstract fun bindScanBarcodeViewModelQQ(hOGTTViewModel: org.nghru_inn.ghru.ui.questionnaire.scanbarcode.ScanBarcodeViewModel): ViewModel


    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.samplemanagement.storage.samplelist.PendingSampleListViewModel::class)
    abstract fun bindPendingSampleListViewModelQQ(pendingSampleListViewModel: org.nghru_inn.ghru.ui.samplemanagement.storage.samplelist.PendingSampleListViewModel): ViewModel
    ...
    @Binds
    @IntoMap
    @ViewModelKey(org.nghru_inn.ghru.ui.activitytracker.activitytracker.reason.ReasonDialogViewModel::class)
    abstract fun bindReasonDialogViewModelXX(ReasonDialogViewModel: org.nghru_inn.ghru.ui.activitytracker.activitytracker.reason.ReasonDialogViewModel): ViewModel
