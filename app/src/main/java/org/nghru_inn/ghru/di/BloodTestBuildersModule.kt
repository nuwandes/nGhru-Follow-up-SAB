...
import org.nghru_inn.ghru.ui.samplemanagement.bloodtesthome.BloodTestHomeFragment
import org.nghru_inn.ghru.ui.samplemanagement.fastingbloodglucose.FastingBloodGlucoseFragment
import org.nghru_inn.ghru.ui.samplemanagement.bloodtesthome.cancel.CancelDialogFragment
import org.nghru_inn.ghru.ui.samplemanagement.fastingbloodglucose.completed.CompletedDialogFragment
import org.nghru_inn.ghru.ui.samplemanagement.hb1ac.Hb1AcFragment
import org.nghru_inn.ghru.ui.samplemanagement.hdl.HDLFragment
import org.nghru_inn.ghru.ui.samplemanagement.hemoglobin.HemoglobinFragment
import org.nghru_inn.ghru.ui.samplemanagement.hogtt.HOGTTFragment
import org.nghru_inn.ghru.ui.samplemanagement.home.SampleMangementHomeFragment
import org.nghru_inn.ghru.ui.samplemanagement.lipidprofile.LipidProfileFragment
import org.nghru_inn.ghru.ui.samplemanagement.pendingsamplelist.PendingSampleListFragment
...
import org.nghru_inn.ghru.ui.samplemanagement.totalcholesterol.TotalCholesterolFragment
import org.nghru_inn.ghru.ui.samplemanagement.triglycerides.TriglyceridesFragment
import org.nghru_inn.ghru.ui.samplemanagement.tubescanbarcode.TubeScanBarcodeFragment
import org.nghru_inn.ghru.ui.samplemanagement.tubescanbarcode.errordialog.ErrorDialogFragment
import org.nghru_inn.ghru.ui.samplemanagement.tubescanbarcode.manualentry.TubeScanManualBarcodeFragment
...
abstract class BloodTestBuildersModule {
    ...
    @ContributesAndroidInjector
    abstract fun contributeErrorDialogFragmentXX(): org.nghru_inn.ghru.ui.registerpatient.scanqrcode.errordialog.ErrorDialogFragment
