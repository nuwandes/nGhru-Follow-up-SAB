...
import org.nghru_inn.ghru.ui.enumeration.concent.ConcentFragment
import org.nghru_inn.ghru.ui.enumeration.concent.reasondialog.ReasonDialogFragment
import org.nghru_inn.ghru.ui.enumeration.createhousehold.CreateHouseholdFragment
import org.nghru_inn.ghru.ui.enumeration.householdmembers.HouseholdMembersFragment
import org.nghru_inn.ghru.ui.enumeration.householdmembers.asigndialog.AsignDialogFragment
import org.nghru_inn.ghru.ui.enumeration.manualentry.ManualEntryFragment
import org.nghru_inn.ghru.ui.enumeration.member.AddHouseHoldMemberFragment
import org.nghru_inn.ghru.ui.enumeration.registergeolocation.RegisterGeolocationFragment
import org.nghru_inn.ghru.ui.enumeration.scanCode.ScanQRCodeFragment
import org.nghru_inn.ghru.ui.registerpatient.scanqrcode.errordialog.ErrorDialogFragment
import org.nghru_inn.ghru.ui.visitedhouseholds.VisitedHouseholdFragment
...
abstract class EnumerationFragmentBuildersModule {
    ...
    @ContributesAndroidInjector
    abstract fun contrubuteCompletedDialogFragment(): org.nghru_inn.ghru.ui.enumeration.completed.CompletedDialogFragment
