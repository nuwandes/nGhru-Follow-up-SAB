...
data class FBGDto(
    ...
    companion object CREATOR : Parcelable.Creator<FBGDto> {
        override fun createFromParcel(parcel: Parcel): FBGDto {
            return FBGDto(parcel)
        }

        override fun newArray(size: Int): Array<FBGDto?> {
