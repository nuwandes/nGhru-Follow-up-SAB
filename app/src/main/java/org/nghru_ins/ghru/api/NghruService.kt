package org.nghru_ins.ghru.api
...
//    fun getHemoglobinStationDevices(): LiveData<ApiResponse<ResourceData<List<StationDeviceData>>>>
    ...
    @GET("/api/v1/participants/followup/{search}")
    fun searchParticipants(@Path("search") search: String): LiveData<ApiResponse<List<ParticipantListItem>>>

    @GET("/api/v2/participants/{screening_id}")
    ...
    @GET("/api/v2/sites")
    fun getSiteNames() : LiveData<ApiResponse<ResourceData<Array<String>>>>
