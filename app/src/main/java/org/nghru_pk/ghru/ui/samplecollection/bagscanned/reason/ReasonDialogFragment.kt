package org.nghru_pk.ghru.ui.samplecollection.bagscanned.reason
...
import org.nghru_pk.ghru.databinding.BagReasonDialogFragmentBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        binding.buttonAcceptAndContinue.singleClick {
            ...
            if (binding.radioGroup.checkedRadioButtonId == -1) {
                ...
                viewModel.setLogin(participant?.participant_id, cancelRequest)
            }
