...
import org.nghru_pk.ghru.ui.report.scanbarcode.ScanBarcodeFragment
import org.nghru_pk.ghru.ui.report.scanbarcode.manualentry.ManualEntryBarcodeFragment
import org.nghru_pk.ghru.ui.report.web.WebFragment
...
abstract class ReportBuildersModule {
    ...
    @ContributesAndroidInjector
    abstract fun contrubuteCompletedDialogFragment(): org.nghru_pk.ghru.ui.report.web.completed.CompletedDialogFragment
}
