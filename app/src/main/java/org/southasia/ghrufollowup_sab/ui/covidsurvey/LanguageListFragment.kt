package org.southasia.ghrufollowup_sab.ui.covidsurvey
...
import org.southasia.ghrufollowup_sab.databinding.LanguageListFragmentBinding
import org.southasia.ghrufollowup_sab.databinding.QuestionnaireListFragmentBinding
...
class LanguageListFragment : Fragment(), Injectable, SwipeRefreshLayout.OnRefreshListener {
    ...
    var binding by autoCleared<LanguageListFragmentBinding>()
    var dataBindingComponent: DataBindingComponent = FragmentDataBindingComponent(this)

    @Inject
    lateinit var viewModel: LanguageListViewModel

    private var adapter by autoCleared<LanguageListAdapter>()
    ...
    override fun onCreateView(
        ...
        val dataBinding = DataBindingUtil.inflate<LanguageListFragmentBinding>(
            inflater,
            R.layout.language_list_fragment,
            container,
            false
        )
        binding = dataBinding
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        val adapter = LanguageListAdapter(dataBindingComponent, appExecutors) { questionnaire ->
            Timber.e(questionnaire.toString())
            findNavController().navigate(R.id.action_languageList_to_surveyFragment , bundleOf("Questionnaire" to questionnaire, "ParticipantRequest" to participant, "meta" to meta))
        }
